...
%macro sca2util(__func__,   ___mn___ =, ___mv___ =,  ___mt___ =,
                ...
                / des='MEP macro SCA2UTIL 1.1';

* 050602  1) Updated code to comply with AIX on mimir. Simply added the sysscpl macro variable          ;
* 100601  1) Updated code to comply with Linux 64bit. Simply added the sysscp macro variable "&sysscp"="LIN X64". Version set to 1.1;
...
%if "&sysscp" NE "WIN" and "&sysscp" NE "VMS" and "&sysscp" ne "LINUX" and "&sysscp" ne "SUN 4" and "&sysscpl" ne "AIX" and "&sysscp" ne "LIN X64" %then %do;
