...
proc glimmix data=s5 order=internal;
  ...
  model event = dephist mage_catb cbyear_cat interval cs plen_cat deform withfather sfinkt forltyp prodeliv bp wperc diab
...
proc glimmix data=s5 order=internal;
  ...
  model event = mage_catb cbyear_cat interval cs plen_cat deform withfather sfinkt forltyp prodeliv bp wperc diab
...
proc glimmix data=s5 order=internal;
  ...
  model event = mage_catb cbyear_cat interval cs preg_len deform withfather psycho sfinkt forltyp prodeliv bp wperc diab
  / dist=poisson offset=logoffset link=log s htype=2;
...
proc glimmix data=s5 order=internal;
  ...
  model event = mage_catb cbyear_cat interval cs preg_len deform withfather sfinkt forltyp prodeliv bp wperc diab
